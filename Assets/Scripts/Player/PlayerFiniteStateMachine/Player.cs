...
public class Player : MonoBehaviour
{
    ...
    public static bool canAttack = true; // used in PlayerGroundedState class to control transitions during slide and roll states
    public static bool canJump = true;   // used in PlayerGroundedState class to control transitions during slide and roll states
    #endregion
    ...
    public void Awake()
    {
        ...
        shield = this.transform.Find("Core").transform.Find("Combat").GetComponent<Shield>();
    ...
    public void Update()
    {
        ...
        canDeployShield = shield.canDeployShield;

        if (canDeployShield && isBlocking)
        {
            shield.canBeDamagedNow = false;
        }
        else shield.canBeDamagedNow = true;
    }
