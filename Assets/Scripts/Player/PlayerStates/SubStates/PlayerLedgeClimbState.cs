...
public class PlayerLedgeClimbState : PlayerState
{
    ...
    {
        //move the corner position from which fire a Raycase a bit facing direction and up to avoid to detect corner itself
    ...
    private Vector2 DetermineCornerPosition()
    {
        ...
        //0.015f tolerance to push the raycast into ledge 
